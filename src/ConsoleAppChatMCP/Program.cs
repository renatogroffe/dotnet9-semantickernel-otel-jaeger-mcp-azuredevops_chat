...
Console.WriteLine("***** Testes com Semantic Kernel + Plugins (Kernel Functions) + Azure DevOps MCP *****");
Console.WriteLine();
...
await using var mcpClient = await McpClientFactory.CreateAsync(new StdioClientTransport(new()
{
    ...
    {
        { "AZURE_DEVOPS_ORG_URL", configuration["MCP:AzureDevOpsOrgUrl"] },
        { "AZURE_DEVOPS_AUTH_METHOD", "pat" },
        { "AZURE_DEVOPS_PAT", configuration["MCP:AzureDevOpsPAT"] }
    }
}));
